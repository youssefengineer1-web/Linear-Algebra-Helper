...
def gauss(
    ...
    while row < equation_count and column < column_count:
        ...
        num_of_elimination = utility.gauss_elimination(equations, row, column, row_nums)
...
def main() -> None:
    ...
    utility.greeting("Row Echelon Form With Gauss Elimination :)")
    ...
    gauss(equations, pivot_indices)

    console.print(f"  [green]𝑹𝑬𝑭  : ")
